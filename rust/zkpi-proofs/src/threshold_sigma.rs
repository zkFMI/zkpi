...
/// Share a caller-owned scalar across distinct, nonzero party identifiers.
/// Used by venue proof adapters without duplicating the common Shamir core.
pub fn share_scalar<R: RngCore + CryptoRng>(
    secret: &Scalar,
    parties: &[PartyId],
    threshold: usize,
    rng: &mut R,
