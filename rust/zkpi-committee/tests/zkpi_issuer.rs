...
use zkpi_committee::zkpi_wire::{decode, encode, Envelope, Message};
use zkpi_proofs::threshold_range::{deal_bits, LocalRangeShares, ValueShares};
...
fn the_public_wire_rejects_cross_node_amount_and_price_messages() {
    ...
    assert_eq!(
        ...
        .unwrap_err(),
        zkpi_committee::zkpi_wire::Error::PartyMismatch
    );
}
